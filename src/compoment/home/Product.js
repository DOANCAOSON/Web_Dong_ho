...
//   const handleUp = () => {
//     setMove(move => move + 1)
//     if (move > (APIFAKEPRODUCT.length / 4 - 3)) {
//       setMove(0)
//     }
//   }
//   const handleDown = () => {
//     setMove(move => move - 1)
//     if (move <= 0) {
//       setMove(Math.ceil(APIFAKEPRODUCT.length / 4 - 3))
//       console.log(move)
//     }
//   }
...
//               {APIFAKEPRODUCT.map((item, index) => {
//                 return <div key={index} className={styles.products_container_list_items}>
//                   <div className={styles.products_container_list_img}>
//                     <img src={item.img} className={styles.products_container_list_img_item} />
//                   </div>
//                   <div className={styles.products_container_list_description}>
